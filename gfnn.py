...
def prepare_model(n_feat, n_hid, n_class, enable_bias, droprate, patience, model_save_path, opt, lr, weight_decay):
...
if __name__ == "__main__":
    ...
    model, loss, early_stopping, optimizer, scheduler = prepare_model(n_feat, n_hid, n_class, enable_bias, droprate, patience, model_save_path, opt, lr, weight_decay)
